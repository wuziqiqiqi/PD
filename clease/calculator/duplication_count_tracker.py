...
class DuplicationCountTracker(object):
    ...
    cluster_list: ClusterList object
    ...
    def __init__(self, setting):
        ...
        self.cluster_list = setting.cluster_list
        self.trans_matrix = setting.trans_matrix
        #self.occ_count_all = self._occurence_count_all_symm_groups()
        self.occ_count_all = self.cluster_list.get_occurence_counts()
    ...
    def _get_norm_factors(self):
        for cluster in self.cluster_list:
            ...
            num_occ = {}
            for key in fig_keys:
                num_occ[key] = self.cluster_list.num_occ_figure(key, 
                    cluster.name, self.symm_group, self.trans_matrix)
