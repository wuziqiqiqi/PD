...
def mg2sn16x6_initial():
    numbers = [
        50, 50, 12, 50, 12, 50, 50, 50, 0, 50, 0, 50, 50, 50, 0, 50, 0, 50, 50, 50, 0, 50, 0, 50
    ]
    positions = [[0.0, 0.0, 0.0], [0.0, 3.375, 3.375], [1.6875, 1.6875, 1.6875],
                 [1.6875, 1.6875, 5.0625], [1.6875, 5.0625, 1.6875], [1.6875, 5.0625, 5.0625],
                 [3.375, 0.0, 3.375], [3.375, 3.375, 0.0], [5.0625, 1.6875, 1.6875],
                 [5.0625, 1.6875, 5.0625], [5.0625, 5.0625, 1.6875], [5.0625, 5.0625, 5.0625],
                 [6.75, 0.0, 0.0], [6.75, 3.375, 3.375], [8.4375, 1.6875, 1.6875],
                 [8.4375, 1.6875, 5.0625], [8.4375, 5.0625, 1.6875], [8.4375, 5.0625, 5.0625],
                 [10.125, 0.0, 3.375], [10.125, 3.375, 0.0], [11.8125, 1.6875, 1.6875],
                 [11.8125, 1.6875, 5.0625], [11.8125, 5.0625, 1.6875], [11.8125, 5.0625, 5.0625]]
...
def mg2sn16x6_final():
    ...
    cell = [[13.51104832407987, 1.175195482e-07, 1.1506351e-09],
...
def mg5sn14x5_initial():
    numbers = [
        50, 50, 12, 50, 50, 12, 50, 50, 0, 12, 12, 50, 50, 50, 0, 50, 0, 50, 50, 50, 0, 12, 0, 50
    ]
    positions = [[0.0, 0.0, 0.0], [0.0, 3.375, 3.375], [1.6875, 1.6875, 1.6875],
                 [1.6875, 1.6875, 5.0625], [1.6875, 5.0625, 1.6875], [1.6875, 5.0625, 5.0625],
                 [3.375, 0.0, 3.375], [3.375, 3.375, 0.0], [5.0625, 1.6875, 1.6875],
...
def mg5sn14x5_final():
    numbers = [50, 50, 12, 50, 50, 12, 50, 50, 12, 12, 50, 50, 50, 50, 50, 50, 50, 12, 50]
    ...
    cell = [[15.54465893532526, 0.0001710673150968, 8.08448379135e-05],
